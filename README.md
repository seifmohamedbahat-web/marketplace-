...
- **Legendary Menu** — six signature burgers with prices, badges, 3D tilt-on-hover cards, plus a sides & shakes row.
- **Our Craft** — pure-CSS 3D stacked burger illustration with floating animation.
...
| File | Purpose |
| --- | --- |
| `index.html` | Page markup (hero, ticker, menu, craft, visit, footer) |
